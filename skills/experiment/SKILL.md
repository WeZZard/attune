...
6. **Record.** Hand the ruling back to the attune:interview Record step with oracle `["human ruled", "per experiment <name>"]`. Then delete the experiment directory — its artifacts are evidence, never design artifacts.
