...
These rules are the whole of the communication guidelines, and they govern every output: replies in conversation and authored prose artifacts alike — design documents, specifications, READMEs, reports, and commit messages (human ruled). Each medium's own conventions — citation formats, schema blocks, diagrams — layer on top. These rules govern the prose between them.
